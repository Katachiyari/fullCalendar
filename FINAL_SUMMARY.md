...
#### Frontend - Pages
5. **static/login.html** - Page de connexion (Bulma)
6. **static/register.html** - Page d'inscription (Bulma)
7. **static/profile.html** - Gestion du profil utilisateur
8. **static/admin-users.html** - Panel d'administration
...
### Via le Navigateur
1. Ouvrir http://localhost:8000/static/register.html
...
### Pour Utiliser
1. `docker-compose up`
2. Ouvrir http://localhost:8000/static/login.html
