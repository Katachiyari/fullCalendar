...
# ou naviguer manuellement vers http://localhost:8000/static/login.html
```
...
→ Redirection automatique vers le calendrier
```
...
```
http://localhost:8000/static/profile.html
...
```
http://localhost:8000/static/admin-users.html
...
### Frontend - Bulma + Vanilla JS
```
Pages:
  static/login.html                  Connexion
  static/register.html               Inscription
  static/index.html                  Calendrier principal
  static/profile.html                Profil utilisateur
  static/admin-users.html            Gestion des utilisateurs (ADMIN)
