...
├─ /login                       (Connexion - SPA)
├─ /register                    (Inscription - SPA)
├─ /calendar                    (Calendrier FullCalendar - SPA)
├─ /profile                     (Gestion profil - SPA)
├─ /admin/users                 (Panel admin - SPA)
...
────────────────────────────────
• Voir le calendrier (/calendar)
• Créer des événements
• Accéder au profil (/profile)
• Admin: Gérer les utilisateurs (/admin/users)
...
Erreur: "Page not found"
  → Vérifier http://localhost:8000/login
